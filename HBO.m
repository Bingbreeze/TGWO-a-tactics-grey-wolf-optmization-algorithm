function [Best_score, Best_pos, Convergence_curve] = HBO(nPop, MaxFEs, lb, ub, dim, fobj)
    ...
    % Convert MaxFEs to iterations
    warriors_no = nPop;
    Max_iter = floor(MaxFEs / nPop);
    Convergence_curve = [];
    FEs = 0;
    ...
    for it = 1:Max_iter
        ...
        if FEs >= next_record_FEs
            Convergence_curve(end+1) = HA_score;
